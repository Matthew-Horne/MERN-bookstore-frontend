...
import { clearCart, removeFromCart, CartItem } from '../../redux/features/cart/cartSlice';
...
const CartPage = () => {
    ...
    const totalPrice = cartItems.reduce((acc: number, item: CartItem) => acc + item.newPrice, 0).toFixed(2);
